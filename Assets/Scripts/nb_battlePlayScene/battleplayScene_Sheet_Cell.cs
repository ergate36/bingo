...
public class battleplayScene_Sheet_Cell : MonoBehaviour
{
    ...
    void OnClick()
    {
        playScene.GetComponent<nb_battlePlayScene>().processDaub((int)sheetIndex, (int)cellIndex);

        playScene.GetComponent<nb_battlePlayScene_UI>().m_effectLayer02Board.Find(
