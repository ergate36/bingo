...
public class setCard : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        GameObject root = GameObject.Find("mainSceneUI/Camera/Anchor/popup_monster/card_List");
    ...
    void OnClick()
    {
        ...
        if (GlobalData.g_global.monsterFlag == 1)
        {
            ...
            else
            {
                ...
                // GameObject root = GameObject.Find("mainSceneUI/Camera/Anchor/popup_monster/input_panel/input_" + setindex) as GameObject;
            }
