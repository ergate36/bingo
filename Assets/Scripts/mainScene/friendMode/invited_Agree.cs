...
public class invited_Agree : MonoBehaviour {
	...
	void Update () {
        ...
        if(GlobalData.g_global.socketState ==(int)SocketClass.STATE.mFriendInviteAgreeComplete && GlobalData.g_global.selectInvite ==0){
            //waitpopup
    ...
    void OnClick()
    {
        ...
        if (GlobalData.g_global.selectSheet != 0)
        {
            ...
            GlobalData.g_global.selectInvite = 0;
