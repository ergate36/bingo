...
public class nb_LobbyBlitzScene : MonoBehaviour
{
    ...
    {
        Transform shop = m_nbLobbySceneUI.uiRoot.transform.Find("shop");
        UILabel count1 = m_nbLobbySceneUI.shop.transform.Find("item_count_1").GetComponent<UILabel>(); //1.single daub
        UILabel count2 = m_nbLobbySceneUI.shop.transform.Find("item_count_2").GetComponent<UILabel>(); //2.coin reward
        UILabel count3 = m_nbLobbySceneUI.shop.transform.Find("item_count_3").GetComponent<UILabel>(); //3.chest
        UILabel count4 = m_nbLobbySceneUI.shop.transform.Find("item_count_4").GetComponent<UILabel>(); //4.double daubs
        UILabel count5 = m_nbLobbySceneUI.shop.transform.Find("item_count_5").GetComponent<UILabel>(); //5.double exp
        UILabel count6 = m_nbLobbySceneUI.shop.transform.Find("item_count_6").GetComponent<UILabel>(); //6.double reward
        UILabel count7 = m_nbLobbySceneUI.shop.transform.Find("item_count_7").GetComponent<UILabel>(); //7.bomb
        UILabel count8 = m_nbLobbySceneUI.shop.transform.Find("item_count_8").GetComponent<UILabel>(); //8.instant win
        UILabel count9 = m_nbLobbySceneUI.shop.transform.Find("item_count_9").GetComponent<UILabel>(); //9.booster
        UILabel count10 = m_nbLobbySceneUI.shop.transform.Find("item_count_10").GetComponent<UILabel>(); //10.triple daubs
