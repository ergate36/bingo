...
public class nb_BattleLobbySheet_btn : MonoBehaviour
{

    private nb_BattleLobbyScene lobbyScene;
    ...
    void Start()
    {
        GameObject obj = GameObject.Find("battleLobbyScene") as GameObject;
        lobbyScene = obj.GetComponent<nb_BattleLobbyScene>();
    }
    ...
    void OnClick()
    {
        ...
        if (nb_GlobalData.g_global.myInfo.ticketCount >= (int)sheetCount)
        {
            ...
            {
                GameObject mainSceneUI = GameObject.Find("battleLobbySceneUI/Camera/Anchor/lobby_layer_Item");
                ...
                mainSceneUI = GameObject.Find("battleLobbySceneUI/Camera/Anchor/nb_lobbyBase");
            ...
            else
            {
                ...
                nbSocket.sCtrl.FrontBeginWrite((int)nb_SocketClass.MsgType.MonsterEnterGameRequest);
                nb_GlobalData.g_global.socketState = (int)nb_SocketClass.STATE.MonsterEnterGameRequest_End;
            }
        }
        ...
        else
        {
            ...
            GameObject mainSceneUI = GameObject.Find("battleLobbySceneUI/Camera/Anchor/nb_lobbyBase");
            ...
            popup = GameObject.Find("battleLobbySceneUI/Camera/Anchor") as GameObject;
