...
public class nb_BattleLobbySceneUI : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        uiRoot = GameObject.Find("battleLobbySceneUI/Camera/Anchor/nb_lobbyBase");
        shop = GameObject.Find("battleLobbySceneUI/Camera/Anchor/shop");
