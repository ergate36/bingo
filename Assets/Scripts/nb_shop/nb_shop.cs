...
public class nb_shop : MonoBehaviour
{
    private enum shopPos
    {
        main,
        lobby_normal,
        lobby_battle,
    ...
    public GameObject gameMoneyGroup;
    ...
    {
        if (gameMoneyGroup == null)
        {
            Debug.Log("moneyGroup null");
        }
        UILabel textLabel1 = gameMoneyGroup.transform.Find("gold_group/t_value").GetComponent<UILabel>();
        UILabel textLabel2 = gameMoneyGroup.transform.Find("credit_group/t_value").GetComponent<UILabel>();
    ...
    public void drawPowerUpMoney()
    {
        ...
        UILabel textLabel3 = gameMoneyGroup.transform.Find("ticket_n_group/t_value").GetComponent<UILabel>();
        UILabel textLabel4 = gameMoneyGroup.transform.Find("ticket_b_group/t_value").GetComponent<UILabel>();
